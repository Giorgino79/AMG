...
urlpatterns = [
    ...
    path(
        "<int:stabilimento_pk>/costi/nuovo/",
        views.nuovo_costo,
        name="nuovo_costo_stabilimento",
    ),
    ...
    path(
        "<int:stabilimento_pk>/documenti/",
        views.documenti_stabilimento,
        name="documenti",
    ),
    # Template: stabilimenti/documenti_stabilimento.html
    # Caricamento nuovo documento per uno stabilimento
    path(
        "<int:stabilimento_pk>/documenti/nuovo/",
        views.nuovo_documento,
        name="nuovo_documento",
    ),
    ...
    path(
        "<int:stabilimento_pk>/utenze/",
        views.utenze_stabilimento,
        name="utenze_stabilimento",
    ),
    # Template: stabilimenti/utenze_stabilimento.html
    # Nuova utenza per uno stabilimento
    path(
        "<int:stabilimento_pk>/utenze/nuova/", views.nuova_utenza, name="nuova_utenza"
    ),
    ...
    path(
        "<int:pk>/toggle-attivo/",
        views.toggle_attivo_stabilimento,
        name="toggle_attivo",
    ),
