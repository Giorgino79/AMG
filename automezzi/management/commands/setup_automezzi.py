...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS("🚗 Inizializzazione App Automezzi...\n"))
        ...
        groups_permissions = {
            "Gestori Automezzi": {
                ...
                "permissions": [
                    ...
                    "view_automezzo",
                    # Documenti
                    "add_documentoautomezzo",
                    "change_documentoautomezzo",
                    "delete_documentoautomezzo",
                    ...
                    "view_manutenzione",
                    # Rifornimenti
                    "add_rifornimentocarburante",
                    "change_rifornimentocarburante",
                    "delete_rifornimentocarburante",
                    "view_rifornimentocarburante",
                    # Eventi
                    "add_eventoautomezzo",
                    "change_eventoautomezzo",
                    "delete_eventoautomezzo",
                    "view_eventoautomezzo",
                    # Tipi carburante
                    "add_tipocarburante",
                    "change_tipocarburante",
                    "delete_tipocarburante",
                    "view_tipocarburante",
                    # Statistiche
            ...
            for perm_codename in group_data["permissions"]:
                try:
                    ...
                    content_type = ContentType.objects.get(
                        app_label="automezzi", model=perm_codename.split("_")[1]
                    )
    ...
    def create_sample_documents(self, automezzo):
        ...
        for doc_data in documenti_data:
            DocumentoAutomezzo.objects.get_or_create(
                automezzo=automezzo, tipo=doc_data["tipo"], defaults=doc_data
            )
    ...
    def create_sample_refuels(self, automezzo, dipendenti):
        ...
        for i in range(5):
            ...
            prezzo_litro = automezzo.tipo_carburante.costo_per_litro + Decimal(
        ...
        EventoAutomezzo.objects.get_or_create(
            ...
            defaults={
                ...
                "dipendente_coinvolto": (
                    random.choice(dipendenti) if dipendenti else None
                ),
            },
        )
