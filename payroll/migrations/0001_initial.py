    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        default=0,
                        max_digits=10,
                        verbose_name="Imponibile Fiscale €",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        default=0,
                        max_digits=10,
                        verbose_name="Detrazioni Fiscali €",
                    ),
                ),
                (
                    "netto_busta",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(verbose_name="Data Inizio Validità"),
                ),
                (
                    "data_fine_validita",
                    models.DateField(
                        blank=True, null=True, verbose_name="Data Fine Validità"
                    ),
                ),
                (
                    "giorni_ferie_annui",
                    models.IntegerField(
                        default=26,
                        help_text="4 settimane + 2 giorni",
                        verbose_name="Giorni Ferie Annui",
                    ),
                ),
                (
                    "ore_rol_annue",
                ...
                (
                    "ha_tredicesima",
                    models.BooleanField(default=True, verbose_name="Ha Tredicesima"),
                ),
                (
                    "ha_quattordicesima",
                    models.BooleanField(
                ...
                (
                    "anni_per_scatto",
                    models.IntegerField(default=2, verbose_name="Anni per Scatto"),
                ),
                (
                    "importo_scatto",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_fine_contratto",
                    models.DateField(
                        blank=True, null=True, verbose_name="Data Fine Contratto"
                    ),
                ),
                (
                    "data_cessazione",
                ...
                (
                    "coniuge_a_carico",
                    models.BooleanField(default=False, verbose_name="Coniuge a Carico"),
                ),
                (
                ...
                (
                    "iban",
                    models.CharField(blank=True, max_length=27, verbose_name="IBAN"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                ...
                                "Percentuale su Retribuzione Totale",
                            ),
                            ("ORARIO", "Calcolato su Ore"),
                        ],
                        max_length=30,
                        verbose_name="Tipo Calcolo",
                    ),
                ),
                (
                    "valore",
                ...
                (
                    "incluso_tfr",
                    models.BooleanField(default=True, verbose_name="Incluso in TFR"),
                ),
                (
                    "incluso_tredicesima",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "codice",
                    models.CharField(
                        help_text="es. 1, 2, 3 o A1, B2, etc.",
                        max_length=20,
                        verbose_name="Codice",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "versione",
                    models.CharField(
                        default="1.0", max_length=20, verbose_name="Versione"
                    ),
                ),
                (
