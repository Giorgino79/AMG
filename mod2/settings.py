...
INSTALLED_APPS = [
    ...
    'allestimento',
    'acquisti',
    'progetti_eventi',  # App gestione progetti eventi cross-reparto
    'logistica',  # App gestione logistica consegne/ritiri
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='AMG Sistema Gestionale <noreply@example.com>')
